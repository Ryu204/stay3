...
app &app::enable_default_systems() {
    ...
    m_ecs_systems
        .add<angelscript_system>(angelscript_system_config{
            .base_script_path = std::filesystem::path{m_config.assets_dir} / "scripts" / "base_component.as",
            .strip_assertion = false,
        })
